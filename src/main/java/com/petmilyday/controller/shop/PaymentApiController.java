...
public class PaymentApiController {
    ...
    public ResponseEntity<?> readyStandardPayment(@RequestBody Map<String, Object> params, HttpSession session) {
        try {
            ...
            body.put("approval_url", "http://43.201.10.123:8080/api/payment/success");
            body.put("cancel_url", "http://43.201.10.123:8080/api/payment/cancel");
            body.put("fail_url", "http://43.201.10.123:8080/api/payment/fail");
