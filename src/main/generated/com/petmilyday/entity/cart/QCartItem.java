...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 658673443L;
    ...
    public final com.petmilyday.entity.product.QProduct product;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new com.petmilyday.entity.product.QProduct(forProperty("product")) : null;
    }
